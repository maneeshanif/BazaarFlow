...
class MarketingService:
    ...
    def __init__(
        ...
        *,
        ...
        if agent_runner is None:
            from app.agents.marketing_agent import generate_campaign_payload

            self._agent_runner = generate_campaign_payload
        else:
            self._agent_runner = agent_runner
        self._pexels_api_key = pexels_api_key or settings.PEXELS_API_KEY or ""
    ...
    def _resolve_user_id(self, explicit: Optional[str]) -> str:
        ...
        env_default = None  # use authenticated user_id from request
    ...
    def _build_config(self, *, page_id: str, access_token: str) -> FacebookConfig:
        kwargs = {
            ...
            "facebook_api_base_url": settings.META_GRAPH_BASE,
            "request_timeout": 30,
            "max_retries": 3,
        }
